...
install_boot_script() {
    ...
    for helper in rayhunter-notify.sh rayhunter-sync-sd.sh rayhunter-cmd.sh rayhunter-disk-monitor.sh rayhunter-ntfy-manager.sh rayhunter-signal.sh rayhunter-temperature.sh; do
        local helper_path=""
